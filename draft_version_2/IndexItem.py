...
from Name import split_fqname
from constant_keys import MTIME, PTIME, ITEMID, LATEST_REVS, NAME_EXACT, UFIELDS, NAMESPACE, NAME, UFIELDS_TYPELIST

#from Revision import create as create_revision
import Revision
...
# This is the indexingmiddleware.Itemt
# don't know what its usage is 
def create(**query):
    """
    Return item with <name> (may be a new or existing item).
    TODO: may take latest_doc as argument...we will see. 
    ...
    latest_doc = indexes.document_search(**query)
...
# def get_revision(idxitem: IndexItem, revid, document_searcher, doc=None):
#     return create_revision(idxitem,  revid, document_searcher,  doc)
